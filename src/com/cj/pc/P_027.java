...
public class P_027 {
	...
	public void p_027() throws Exception {
		...
		isExist = existElement(driver, By.xpath("//*[@id='content']/div[2]/div[1]/div[2]/div[1]/div[4]/div[1]/div/div/a"), "선택옵션");
		if (isExist) {
			Thread.sleep(3000);
			driver.findElement(By.xpath("//*[@id='content']/div[2]/div[1]/div[2]/div[1]/div[4]/div[1]/div/div/a")).click();
			Thread.sleep(3000);
			driver.findElement(By.xpath("//*[@id='content']/div[2]/div[1]/div[2]/div[1]/div[4]/div[1]/div/div/div/ul/li[1]/a")).click();
			Thread.sleep(3000);
			System.out.println("상품선택");
													
		} else {	
			System.out.println("선택창 없음");
		}
