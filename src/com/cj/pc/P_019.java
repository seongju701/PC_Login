...
public class P_019 {
	...
	public void p_019() throws Exception {
		...
		// 팝업닫기
		isExist = existElement(driver,
				By.xpath("//*[@id=\"content\"]/div[2]/div[1]/div[2]/div[1]/div[4]/div[2]/div/div/a"), "옵션");
		if (isExist) {
			driver.findElement(By.xpath("//*[@id=\"content\"]/div[2]/div[1]/div[2]/div[1]/div[4]/div[2]/div/div/a"))
					.click();
			Thread.sleep(3000);
			driver.findElement(
					By.xpath("//*[@id=\"content\"]/div[2]/div[1]/div[2]/div[1]/div[4]/div[2]/div/div/div/ul/li[1]/a"))
					.click();
			Thread.sleep(3000);
