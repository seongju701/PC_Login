 ...
 * Assertion : 로그인 후 장바구니 담기가 가능합니다. Text 체크
 *
 */
...
public class P_034 {
	...
	public void p_034() throws Exception {
		...
		Thread.sleep(3000);
		// 장바구니 담기 클릭
		driver.findElement(By.xpath("//*[@id=\"lst_cate_result\"]/li/a/span[1]")).click();
		Thread.sleep(3000);
		...
		Thread.sleep(3000);
		// 장바구니 1개 담김 체크
		if ("로그인 후 장바구니 담기가 가능합니다.".equals(driver.switchTo().alert().getText())) {
			System.out.println("TC_34 PASS");
			assertTrue(true);
			return;
		} else {
			System.out.println("TC_34 FAIL");
			assertTrue(false);
		}
	}
