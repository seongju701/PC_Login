...
public class P_072 {
	...
	public void p_068() throws Exception {
		...
		driver.findElement(By.xpath("//*[@id=\"id_input\"]")).sendKeys("extract10");
		...
		Thread.sleep(3000);
		// text check
        if ("실버".equals(driver.findElement(By.xpath("//*[@id=\"content\"]/div/div[1]/div[1]/div/div[1]")).getText())) {
           System.out.println("TC_072 PASS");
           assertTrue(true);
           return;
        } else {
           System.out.println("TC_072 FAIL");
           assertTrue(false);
			}
	}
