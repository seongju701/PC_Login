...
public class P_071 {
	...
	public void p_068() throws Exception {
		...
		Thread.sleep(3000);
		// text check
        if ("골드".equals(driver.findElement(By.xpath("//*[@id=\"content\"]/div/div[1]/div[1]/div/div[1]")).getText())) {
           System.out.println("TC_071 PASS");
           assertTrue(true);
           return;
        } else {
           System.out.println("TC_071 FAIL");
           assertTrue(false);
			}
	}
